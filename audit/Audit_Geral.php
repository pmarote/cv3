...
$pr->aud_registra(new PrMenu("audit_tabelas", "_Audit", "Todas as Tabelas", "audit"));

function audit_tabelas() {
	...
	$lbl_obs1 	= new GtkLabel("Este módulo exporta para Excel as seguintes tabelas que estão dentro de audit.db3:");
  ...
  $pr->inicia_excel('Audit_TodasTabelas');
