...
$pr->aud_registra(new PrMenu("xml_tabelas", "_XML", "Todas as Tabelas", "xml"));

function xml_tabelas() {
  ...
  $lbl_obs1 	= new GtkLabel("Este módulo exporta para Excel as seguintes tabelas que estão dentro de xml.db3:");
  ...
  $pr->inicia_excel('XML_TodasTabelas');
