...
$pr->aud_registra(new PrMenu("ecd_bal_dinamico", "E_CD", "Saldos Mensais e Diários das Contas Patrimoniais e Confronto com Balanço", "ecd"));

function ecd_bal_dinamico() {
  ...
  $lbl_obs1 	= new GtkLabel("Este módulo mostra os Saldos Mensais e Diários das Contas Patrimoniais, exceto de Resultado, ");
  $lbl_obs2 	= new GtkLabel("efetuando também o confronto com Balanço. Os valores são extraídos com base no Diário, partindo dos Saldos Iniciais");
  $lbl_obs3 	= new GtkLabel("Nos saldos diários, são mostrados apenas os dias em que há lançamentos.");
...
");
  // Primeiro, verifica todas as contas (exceto de resultado) que tem movimento ou saldo inicial
...
");
  // em seguida, verifica todos os dias que tem movimento de conta (exceto de resultado)
...
");
  ...
  // saldos iniciais das contas (exceto de resultado) (o query abaixo retorna também os saldos iniciais das contas sintéticas)
...
");
  ...
  // Saldos a cada dia de movimentos, incluindo lançamentos de encerramento
...
");
  ...
  $pr->inicia_excel('ECD_Saldos_Mens_Dia_Balanco');
...
';
  ...
  $pr->abre_excel_sql("Saldos_Mensais", "Saldos Mensais, no seguinte Padrão: Contas de Ativo: Positivo = Débito; Negativo = Crédito  --  Contas de Passivo, Patrimônio Líquido, Compensação ou Outras: Positivo = Crédito; Negativo = Débito", $sql, $col_format, $cabec, $form_final);
...
';
  ...
  $pr->abre_excel_sql("Saldos_Diários", "Saldos Diários, no seguinte Padrão: Contas de Ativo: Positivo = Débito; Negativo = Crédito  --  Contas de Passivo, Patrimônio Líquido, Compensação ou Outras: Positivo = Crédito; Negativo = Débito", $sql, $col_format, $cabec, $form_final);



  // Balanco Dinâmico Mensal
  $sql = "
SELECT 
  dt_ini, dt_fin, 
...
2 – Passivo e Patrimônio Líquido;',
	...
	"Sld_Ini" => "Saldo Inicial"
	{$cabec_final_mes},
	'Vl_Bal_J100' => 'Valor total do Código de aglutinação no Balanço Patrimonial no exercício informado, ou de período definido em norma específica, no Registro J100.',
	'Ind_DC_Bal_J100' => "Indicador da situação, no Registro J100, do saldo informado no campo anterior:
D - Devedor;
C – Credor."
);
EOD;
...
';
  ...
  $pr->abre_excel_sql("Balanco_Dinamico_Mes", "Saldos Mensais agrupados conforme Balanco, no seguinte Padrão: Contas de Ativo: Positivo = Débito; Negativo = Crédito  --  Contas de Passivo, Patrimônio Líquido, Compensação ou Outras: Positivo = Crédito; Negativo = Débito", $sql, $col_format, $cabec, $form_final);
...
';
  ...
  $pr->abre_excel_sql("Balanco_Dinamico_Dia", "Saldos Diários agrupados conforme Balanco, no seguinte Padrão: Contas de Ativo: Positivo = Débito; Negativo = Crédito  --  Contas de Passivo, Patrimônio Líquido, Compensação ou Outras: Positivo = Crédito; Negativo = Débito", $sql, $col_format, $cabec, $form_final);
